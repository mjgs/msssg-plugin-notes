...
class Notes {
  ...
  getTemplate() {
    return `
      ...
      <%- await renderComponent(new components.PostsByCalendar(dictionaryName, webRoot, perPage, postsByCalendarItemComponentName, postsByCalendarItemComponentEnvProps, 'chronological'), { itemTitleHtmlTag, listClass }); %>
